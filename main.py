    ...
    if callback:
        ...
        if callback_data.startswith("approve_"):
            ...
            if post_id in pending_posts:
                ...
                send_telegram(f"✅ Post paylaşıldı! {result}")
...
def trigger_post():
    ...
    # Varsayılan görsel URL (kendiniz değiştirebilirsiniz)
    ...
    telegram_msg = f"""📸 <b>Günlük Post Hazır!</b>
...
if __name__ == "__main__":
    # Telegram webhook kur
    telegram_webhook_url = os.environ.get("RAILWAY_PUBLIC_DOMAIN", "")
    if telegram_webhook_url:
        requests.get(
            f"https://api.telegram.org/bot{TELEGRAM_BOT_TOKEN}/setWebhook",
            params={"url": f"https://{telegram_webhook_url}/telegram-webhook"}
        )
